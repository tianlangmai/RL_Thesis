...
import sys
sys.path.append('/home/tianlang/REL_project_ws/src/')
...
class RobotGazeboEnv(gym.Env):
    ...
    def _update_episode(self):
        ...
        #self.cumulative_reward.append(self.cumulated_episode_reward)
        #plt.xlabel('episode_number')
        #plt.ylabel('epsiode_reward')
        #plt.plot(self.episodes, self.cumulative_reward, 'g-')
        #plt.pause(0.4)
